...
<div class="row g-0">
    <div class="col-md-4">
        <img src="${peliBuscada.imagen}"
            class="card-img-top" alt="${peliBuscada.titulo}">
    </div>
    <div class="col-md-7">
        <div class="card-body">
            <h5 class="card-title">${peliBuscada.titulo}</h5>
            <p class="card-text">${peliBuscada.descripcion}</p>
            <p class="card-text"><small>${peliBuscada.genero} <span class="badge text-bg-info text-light rounded-pill">aventura</span></small></p>
            <p class="card-text"><small>Año: ${peliBuscada.anio} </small></p>
            <p class="card-text"><small>Duracion: ${peliBuscada.duracion} min</small></p>
